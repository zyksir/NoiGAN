...
bash run.sh train DistMult YAGO3-10 $1 fake100 1024 400 50 24.0 1.0 0.0002 100000 4 -r 0.00001 --fake 100
bash run.sh train DistMult YAGO3-10 $1 fake70 1024 400 50 24.0 1.0 0.0002 100000 4 -r 0.00001 --fake 70
#bash run.sh train DistMult YAGO3-10 $1 fake50 1024 400 50 24.0 1.0 0.0002 100000 4 -r 0.00001 --fake 50
#bash run.sh train DistMult YAGO3-10 $1 fake30 1024 400 50 24.0 1.0 0.0002 100000 4 -r 0.00001 --fake 30