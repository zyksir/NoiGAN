...
# 
bash run.sh train DistMult FB15k 1 debug 1024 256 2000 500.0 1.0 0.001 150000 16 -r 0.000002
...
bash run.sh train TransE wn18 0 baseline 512 1024 500 12.0 0.5 0.0001 80000 8
bash run.sh train TransE wn18rr 0 baseline 512 1024 500 6.0 0.5 0.00005 80000 8
bash run.sh train TransE FB15k 0 baseline 1024 256 1000 24.0 1.0 0.0001 150000 16


bash run.sh train DistMult FB15k-237 0 baseline 1024 256 2000 200.0 1.0 0.001 100000 16 -r 0.00001
bash run.sh train DistMult wn18 0 baseline 512 1024 1000 200.0 1.0 0.001 80000 8 -r 0.00001
bash run.sh train DistMult wn18rr 0 baseline 512 1024 1000 200.0 1.0 0.002 80000 8 -r 0.000005
bash run.sh train DistMult FB15k 0 baseline 1024 256 2000 500.0 1.0 0.001 150000 16 -r 0.000002
