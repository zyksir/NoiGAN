...
bash run.sh train TransE wn18rr $1 CLF30_soft 512 256 500 6.0 0.5 0.00005 80000 8 --fake 30 --method clf -init ./models/TransE_wn18rr_fake30 --num 1
bash run.sh train TransE wn18rr $1 CLF30_hard 512 256 500 6.0 0.5 0.00005 80000 8 --fake 30 --method clf -init ./models/TransE_wn18rr_fake30 --num 1000
...
bash run.sh train TransE YAGO3-10 $1 fake50 512 256 100 12.0 0.5 0.001 100000 8 --fake 50
bash run.sh train TransE YAGO3-10 $1 CLF50_soft 512 256 100 12.0 0.5 0.001 100000 8 --fake 50 --method clf -init ./models/TransE_YAGO3-10_fake50 --num 1
bash run.sh train TransE YAGO3-10 $1 CLF50_hard 512 256 100 12.0 0.5 0.001 100000 8 --fake 50 --method clf -init ./models/TransE_YAGO3-10_fake50 --num 1000
bash run.sh train TransE YAGO3-10 $1 fake30 512 256 100 12.0 0.5 0.001 100000 8 --fake 30
bash run.sh train TransE YAGO3-10 $1 CLF30_soft 512 256 100 12.0 0.5 0.001 100000 8 --fake 30 --method clf -init ./models/TransE_YAGO3-10_fake30 --num 1
bash run.sh train TransE YAGO3-10 $1 CLF30_hard 512 256 100 12.0 0.5 0.001 100000 8 --fake 30 --method clf -init ./models/TransE_YAGO3-10_fake30 --num 1000